...
class PaymentProcessorSpec extends TestKit(ActorSystem("PaymentProcessorSpec"))
  ...
  "PaymentProcessor" should {
    "receive messages" in {
      ...
      val xml = <AuthorizationRequest xmlns="http://pmtsvc.org/authorization" xmlns:tns="http://pmtsvc.org/authorization"
      ...
      expectMsg("<AuthorizationResponse xmlns=\"http://pmtsvc.org/authorization\" " +
        "xmlns:tns=\"http://pmtsvc.org/authorization\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" " +
    ...
    "reject malformed messages" in {
      ...
      expectMsg("<ErrorResponse xmlns=\"http://pmtsvc.org/authorization\" " +
        "xmlns:tns=\"http://pmtsvc.org/authorization\" xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" " +
        "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">" +
